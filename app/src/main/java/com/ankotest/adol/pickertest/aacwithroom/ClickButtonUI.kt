...
class ClickButtonUI(private var data: SignUpTable, private var callBack: () -> Unit) : RecyclerView.Adapter<ClickButtonUI.ViewHolder>() {
...
//        oldStatus.size.pln()
    ...
    //View ---------------------
    private fun headOB(ui: AnkoContext<ClickButtonUI>): View {
        return ui.apply {
            linearLayout {
    ...
    private fun endOB(ui: AnkoContext<ClickButtonUI>): View {
        return ui.apply {
            linearLayout {
                lparams(matchParent, dip(55))
                gravity = Gravity.CENTER
